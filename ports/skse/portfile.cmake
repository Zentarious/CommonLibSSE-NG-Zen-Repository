...
message(status "Build plugin is set to: ${BUILD_PLUGIN}. If off then it will not install anything for SKSE64.")
if (BUILD_PLUGIN)
    ...
    message(STATUS "The current sourth path is first set to: ${SOURCE_PATH}.")
...
if (INSTALL_SCRIPTS)
  ...
  vcpkg_extract_source_archive("${SKSE_DISTRO}")
  ...
  if (NOT BUILD_PLUGIN)
    file(INSTALL "${CURRENT_BUILDTREES_DIR}/src/skse64_2_02_03/src/skse64/skse64_license.txt"
    DESTINATION "${CURRENT_PACKAGES_DIR}/share/${PORT}"
    RENAME copyright
    )
  endif()
